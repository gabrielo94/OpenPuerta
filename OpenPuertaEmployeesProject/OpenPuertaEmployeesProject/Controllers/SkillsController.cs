...
namespace OpenPuertaEmployeesProject.Controllers
{
    public class SkillsController : Controller
    {
        ...
        /// Api for skills
        /// </summary>
        /// <returns>returns all skills in json format</returns>
        public ActionResult Api()
        {

            string result = JsonConvert.SerializeObject(db.Skills.ToList());
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Level")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Level")] Skill skill)
        {
            if (ModelState.IsValid)
            {
